...
- [🏦 ValenciaBank — Plataforma Bancaria Digital con IA](#-valenciabank--plataforma-bancaria-digital-con-ia)
  - [📑 Índice](#-índice)
  ...
  - [🛠 Instalación y configuración](#-instalación-y-configuración)
    ...
    - [4. Instalar dependencias del frontend](#4-instalar-dependencias-del-frontend)
  - [🚀 Ejecución](#-ejecución)
    - [Backend (puerto 8080)](#backend-puerto-8080)
    - [Frontend (puerto 5173)](#frontend-puerto-5173)
